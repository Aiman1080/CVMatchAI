...
import {
  ...
  Brain, FileText, MessageSquareText, Trophy, ClipboardList, Mail, MailSearch,
...
export default function LandingPage() {
  ...
  const AI_FEATURES = [
    ...
    {
      icon: MailSearch,
      title: t.landing.aiFeatures.emailScanning.title,
      desc: t.landing.aiFeatures.emailScanning.desc,
      tag: t.landing.aiFeatures.emailScanning.tag,
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 via-blue-100 to-blue-200 dark:from-slate-950 dark:via-blue-950 dark:to-blue-950 text-gray-900 dark:text-white py-16 sm:py-28 px-4 sm:px-6">
        {/* Background blurs */}
        ...
        {/* Mock UI */}
        <div className="relative max-w-4xl mx-auto mt-12 sm:mt-20">
          <div className="bg-white/80 dark:bg-white/5 backdrop-blur-sm border border-blue-200 dark:border-white/10 rounded-2xl p-4 sm:p-6 shadow-2xl">
      ...
      {/* ═══ AI FEATURES ═══ */}
      <section id="ai-features" className="py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-br from-blue-200 via-blue-100 to-indigo-100 dark:from-slate-950 dark:via-blue-950 dark:to-indigo-950 text-gray-900 dark:text-white">
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollReveal delay={100}>
            <div className="group mb-8 p-5 sm:p-8 rounded-2xl bg-gradient-to-r from-blue-600/20 to-cyan-600/20 border border-blue-500/30 backdrop-blur-sm hover:from-blue-600/30 hover:to-cyan-600/30 transition-all duration-300">
            ...
            {AI_FEATURES.slice(1).map((feature, i) => {
              ...
              return (
                <ScrollReveal key={i} delay={i * 100}>
                  <div className="group p-5 sm:p-6 rounded-2xl bg-white/60 dark:bg-white/5 border border-blue-200 dark:border-white/10 hover:border-blue-300 dark:hover:border-white/20 transition-all duration-300">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {PLATFORM_FEATURES.map((feature, i) => {
              ...
              return (
                <ScrollReveal key={i} delay={i * 100}>
                  <div className="p-5 sm:p-6 rounded-2xl border border-gray-100 dark:border-gray-800 hover:border-blue-200 dark:hover:border-blue-700 hover:shadow-md transition-all duration-300 border-l-0 hover:border-l-[3px] hover:border-l-blue-500">
