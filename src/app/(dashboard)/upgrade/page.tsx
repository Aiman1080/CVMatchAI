...
const plans = [
  { name: 'Free', icon: Zap, price: '€0', period: 'forever', color: 'border-gray-200 dark:border-gray-700', iconColor: 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300', features: ['5 active vacancies', '50 candidates/month', 'AI match scoring', 'Basic dashboard'], cta: 'Current Plan', disabled: true },
  ...
  { name: 'Enterprise', icon: Building2, price: 'Custom', period: 'pricing', color: 'border-purple-200 dark:border-purple-800', iconColor: 'bg-purple-100 dark:bg-purple-900 text-purple-600 dark:text-purple-400', features: ['Unlimited everything', 'Custom AI configuration', 'API & webhooks', 'SSO / SAML', 'Dedicated account manager', 'SLA 99.9%'], cta: 'Contact Sales', disabled: false },
]
