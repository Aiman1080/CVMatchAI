  ...
  const rows = candidates.map((c, i) => {
    ...
    <div class="candidate-card">
      ...
      <div class="details-grid">
        ${strengths.length ? `<div class="detail-section strengths"><div class="detail-title">✅ Strengths</div>${strengths.map((s: string) => `<div class="detail-item">• ${s}</div>`).join('')}</div>` : ''}
        ${weaknesses.length ? `<div class="detail-section weaknesses"><div class="detail-title">⚠️ Areas of attention</div>${weaknesses.map((w: string) => `<div class="detail-item">• ${w}</div>`).join('')}</div>` : ''}
      </div>
      ${skills ? `<div class="skills-row"><span class="skills-label">Skills:</span> <span class="skills-list">${skills}</span></div>` : ''}
      ${c.experience ? `<div class="detail-block"><div class="detail-title">💼 Experience</div><div class="detail-text">${c.experience}</div></div>` : ''}
      ${c.education ? `<div class="detail-block"><div class="detail-title">🎓 Education</div><div class="detail-text">${c.education}</div></div>` : ''}
    </div>`
  }).join('')
  ...
  <div class="page">
    <div class="header">
      ...
      <div class="header-meta">
        ...
        <div>${date}</div>
        <div>Generated by ${generatedBy}${company ? ` · ${company}` : ''}</div>
      </div>
    </div>
